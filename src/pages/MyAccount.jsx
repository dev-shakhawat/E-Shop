    ...
    <div className="pt-16 pb-20 ">
      <Container>
        ...
        <div className="w-fit p-10 border border-tertary rounded-[25px] ">
          ...
          {/* name */}
          <h2 className=" font-poppins font-semibold text-[26px] leading-[30px] text-primary mt-10 text-center  ">Amelia Robert</h2>
          <p className=" font-montserrat font-normal text-sm leading-5 text-primary mt-2 text-center   ">amelia.watson@eshop.com</p>
