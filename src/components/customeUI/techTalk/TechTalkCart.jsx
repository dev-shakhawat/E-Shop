...
function TechTalkCart({ title, buttontxt, date, buttonlink, image = product }) {
  return (
    ...
    >
      ...
      {/*  body/text  */}
      <div className="">
        <h3 className="line-clamp-2 font-poppins font-semibold text-[13px] sm:text-base md:text-xl lg:text-[24px] lg:leading-[30px] text-primary mt-8  ">
          {title}
        </h3>
        ...
        <div className="flex items-center justify-between mt-2 sm:mt-4 md:mt-6 lg:mt-8">
          ...
          <div className="flex items-center gap-2.5">
            <Timer />
            <span
              className={`font-montserrat font-normal text-sm leading-[20px] text-primary`}
            >
              {date}
            </span>
          </div>
