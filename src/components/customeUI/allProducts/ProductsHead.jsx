...
export default function ProductsHead() {
  ...
  return (
    ...
    {/* short by tab */}
    <div className="lg:flex justify-between 2xl:mt-6 xl:mt-5 md:mt-4 mt-1    ">
        ...
        <div className="flex lg:justify-between gap-3 flex-wrap mt-3 md:mt-0 ">
            ...
            {/* short one */}
            <div className="flex gap-4 items-center 2xl:mr-6 xl:mr-4 lg:mr-2 mr-0 relative  after:content-[''] lg:after:w-[1px] after:h-[32px] after:bg-tertary after:absolute after:top-1/2 after:-translate-y-1/2 after:-right-[24px]   ">
            ...
            {/* short two */}
            <div className="flex gap-4 items-center 2xl:mx-6 xl:mx-5 md:mx-4 mx-2 relative  after:content-[''] lg:after:w-[1px] after:h-[32px] after:bg-tertary after:absolute after:top-1/2 after:-translate-y-1/2 after:-right-[24px]">
            ...
            <div className="2xl:ml-6 xl:ml-5 md:ml-4 ml-0 flex items-center gap-4 ">
                ...
                {/* filters */}
                <button onClick={(e) => handleFilter(e)} type="button"><CiFilter className='text-xl text-[#9c9c9c] cursor-pointer md:hidden inline-block  '/></button>
            </div>
