...
export default function Notification({success, message}) {
  return (
    <div className={` ${success ? "bg-green-500/30 backdrop-blur-md " : "bg-red-600/50 backdrop-blur-[2px]"} rounded-md font-poppins font-semibold text-base leading-[24px} animate-notify fixed top-1/2 left-1/2 -translate-1/2 z-2 py-3 px-5  `}>
