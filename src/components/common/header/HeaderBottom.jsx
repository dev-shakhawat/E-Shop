    ...
    <div className={`bg-brand py-6  `}>
      <Container>
        <div className="flex justify-between  ">
          ...
          <ul className={`flex gap-5 md:gap-x-10 lg:gap-x-15 xl:gap-x-20`}>
            ...
            >
              ...
              {isdropdown ? (
                <ArrowDown
                  color={`#ffffff`}
                  style={`w-[12px] h-[6x] rotate-[180deg]`}
                />
              ) : (
                <ArrowDown color={`#ffffff`} style={`w-[12px] h-[6x]`} />
              )}
          ...
          {/*  right  */}
          <ul
            className={`md:flex gap-5 md:gap-x-10 lg:gap-x-15 xl:gap-x-20  hidden`}
          >
            <li className={`navLink `}>
              <Link to={`#`}>
                <span>{t("LIMITED_SALE")}</span>👋
              </Link>
            </li>
            <li className={`navLink `}>
          ...
          <HiOutlineMenu
            className={` text-lg text-white cursor-pointer md:hidden `}
          ...
          {isModal && (
            <div className="fixed top-0 right-0 bg-tertary/60 shadow-2xl w-full h-screen  md:hidden ">
              <div className="bg-white ml-auto w-1/2 h-screen relative">
                ...
                >
                  <li
                    className={`font-montserrat font-semibold text-[12px] text-primary `}
                  >
                    <Link to={`#`}>
                      <span>{t("LIMITED_SALE")}</span>👋
                    </Link>
