      ...
      <Container>
        <div className={`flex justify-between items-center `}>
          ...
          <div className="flex items-center  ">
            {/* currency */}
            <div className="lg:mr-12  cursor-pointer flex   ">
              <div
                ref={currencyRef}
              ...
              >
                <div className=" flex items-center ">
                  <span className="mr-3 text-[12px] sm:text-[14px]  truncate whitespace-nowrap overflow-hidden font-montserrat leading-5 ">
                    {selectedCurrency}
                  </span>
                  {isCurrencyDropdown ? (
                ...
                {isCurrencyDropdown && (
                  <div className="flex flex-col gap-1   absolute top-8 left-0 lg:-left-7 z-[1] bg-white  rounded-md w-[140px] lg:w-[180px] max-h-[400px] h-fit   border border-tertary ">
                    <div className={`max-h-[200px] overflow-y-scroll`}>
                      {correncies.length === 0 ? (
                        <p
                          className={`font-montserrat text-primary text-[12px] leading-[20px]`}
                        >
                          No Country Found
                        </p>
                      ) : (
                        correncies.map((item) => (
                          ...
                          >
                            <span
                              className={`w-[150px] text-[14px] truncate whitespace-nowrap overflow-hidden`}
                            >
                              {item}
                            </span>
                          </div>
            ...
            {/*  language  */}
            <div className="lg:mr-14  lg:w-[112px] cursor-pointer flex relative after:content-[''] after:w-[1px] after:h-[20px] lg:after:h-[32px] after:bg-tertary after:absolute after:left-[-10px] lg:after:left-[-27px] after:top-[0px] lg:after:top-[-5px]     ">
              <div
                ref={countryRef}
                className="flex relative  "
              ...
              >
                <div className=" flex items-center ">
                  ...
                  />
                  <span className="mx-2 w-[70px] text-[12px] sm:text-[14px]  truncate whitespace-nowrap overflow-hidden font-montserrat leading-5 ">
