  ...
  return (
    <Container>
      <div className="flex justify-between items-center py-3 lg:py-8  ">
        ...
        {/* search/cart/user */}
        <div className="flex items-center justify-end  w-full  h-[30px] md:h-fit   ">
          {/* search */}
          <div
          ...
          >
            ...
            <div className="hidden sm:block">
              <p className="font-montserrat font-normal text-primary text-[13px] lg:text-base leading-[24px]">
                {t("Cart")}
              </p>
